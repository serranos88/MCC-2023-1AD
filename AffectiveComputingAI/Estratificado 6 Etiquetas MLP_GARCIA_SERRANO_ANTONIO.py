...
Accuracy 49.1%
Estratificado 6 Etiquetas MLP 
Optimizador Adam

NOTA: detecta 4 emociones, bored, excited, focused, engaged
'''
import cv2
import numpy as np
...
affective_MLP_model = load_model("C:\\Users\\josek\\Documents\\gitMCC\\MCC-2023-1AD\\AffectiveComputingAI\\affective_MLP_trainned_491acc_6emo_stratified.h5")
...
def affectiveClassificationMLP(frame):
    ...
    try:
        ...
        label = "MLP estratificada: " + labels[idx_label]
